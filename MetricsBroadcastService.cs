...
/// No importa cuántas pantallas estén abiertas (general + N hornos a la vez): el SP se
/// ejecuta una sola vez por ciclo, sin importar cuántos dashboards distintos lo consuman.
/// </summary>
public class MetricsBroadcastService : BackgroundService
{
    ...
    private async Task PushAllSnapshotsAsync(CancellationToken ct)
    {
        try
        {
            ...
            // Una sola llamada al SP para todo este ciclo.
